...
```groovy
implementation 'com.github.javakam:dialog.core:7.0.0@aar'  //核心库, 2个类
implementation 'com.github.javakam:dialog.usage:7.0.0@aar' //常用样式(如: 加载中弹窗)
```
...
```groovy
implementation 'com.github.javakam:dialog.bottomsheet:7.0.0@aar' //底部弹窗(必需下面的 widget.optionview 框架)
implementation 'com.github.javakam:widget.optionview:7.0.0@aar'  //单选/多选的RecyclerView,基于EasyAdapter实现
```
